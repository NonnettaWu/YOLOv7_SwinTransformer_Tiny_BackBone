...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, backbone='backbone',pretrained=False, input_shape=[224, 224]):
        ...
        #   输入图片是640, 640, 3
        #-----------------------------------------------#
        if backbone == 'swin_transfomer_tiny':
        ...
        #   20, 20, 1024
        #---------------------------------------------------#
            feat1_c, feat2_c, feat3_c = [192, 384, 768]
            self.conv_1x1_feat1 = Conv(feat1_c, base_channels * 2, 1, 1)
            self.conv_1x1_feat2 = Conv(feat2_c, base_channels * 4, 1, 1)
            self.conv_1x1_feat3 = Conv(feat3_c, base_channels * 8, 1, 1)
